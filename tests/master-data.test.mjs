...
test('all ten categories accept valid bilingual values and canonicalize codes',()=>{for(const [category] of CATEGORIES)assert.equal(validateMaster({...base,category}).code,'PCS');});
